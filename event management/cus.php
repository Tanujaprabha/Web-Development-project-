...
<head>
  <meta charset="UTF-8">
  <title>Custom Event Package</title>
  <style>
     body {
...
<body>
  ...
  <div class="container">
    <h1>Custom Event Planner 🎉</h1>
    <p class="catchy">Tailor your event with our flexible service options to match your needs!</p>
